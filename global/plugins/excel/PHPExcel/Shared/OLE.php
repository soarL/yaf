...
namespace plugins\excel\PHPExcel\Shared;

use plugins\excel\PHPExcel\Reader\Exception as ReaderException;
use plugins\excel\PHPExcel\Shared\OLE\PPS;
use plugins\excel\PHPExcel\Shared\OLE\PPS\Root as PPSRoot;
use plugins\excel\PHPExcel\Shared\OLE\PPS\File as PPSFile;
/**
	...
	public function getStream($blockIdOrPps)
	{
		...
		if (!$isRegistered) {
			stream_wrapper_register('ole-chainedblockstream',
				PHPEXCEL_SPACE.'PHPExcel\Shared\OLE\ChainedBlockStream');
			$isRegistered = true;
		}
		...
		if ($blockIdOrPps instanceof PPS) {
	...
	public function _readPpsWks($blockId)
	{
		...
		for ($pos = 0; ; $pos += 128) {
			...
			case self::OLE_PPS_TYPE_ROOT:
				$pps = new PPSRoot(null, null, array());
				$this->root = $pps;
				break;
			case self::OLE_PPS_TYPE_DIR:
				$pps = new PPS(null, null, null, null, null,
								   null, null, null, null, array());
				break;
			case self::OLE_PPS_TYPE_FILE:
				$pps = new PPSFile($name);
				break;
			default:
				continue;
			}
