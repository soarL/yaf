...
use plugins\excel\PHPExcel\Calculation\DateTime as CalculationDateTime;
/**
...
class Date
{
	...
	public static function stringToExcel($dateValue = '') {
		...
		$dateValueNew = CalculationDateTime::DATEVALUE($dateValue);

		if ($dateValueNew === Functions::VALUE()) {
			return FALSE;
		} else {
			if (strpos($dateValue, ':') !== FALSE) {
				$timeValue = CalculationDateTime::TIMEVALUE($dateValue);
