 ...
 * @copyright	Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Gnumeric extends ReaderAbstract implements IReader
{
	/**
	 * Formats
	 *
	...
	public function listWorksheetNames($pFilename)
	{
		...
		$xml = new XMLReader();
		$xml->open(
			'compress.zlib://'.realpath($pFilename), null, Settings::getLibXmlLoaderOptions()
		);
...
//		echo '</pre><hr />';
//
		$xml = simplexml_load_string($gFileData, 'SimpleXMLElement', Settings::getLibXmlLoaderOptions());
...
//					echo '<br />';
					...
					if ((!$this->_readDataOnly) ||
						(SharedDate::isDateTimeFormatCode((string) $styleAttributes['Format']))) {
						$styleArray = array();
