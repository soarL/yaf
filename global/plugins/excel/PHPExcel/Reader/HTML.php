 ...
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class HTML extends ReaderAbstract implements IReader
{
	/**
	 * Input encoding
	 *
	...
	private $_formats = array( 'h1' => array( 'font' => array( 'bold' => true,
							   ...
							   'a'  => array( 'font' => array( 'underline' => true,
															   'color' => array( 'argb' => Color::COLOR_BLUE,
															                   ),
															 ),
											),	//	Blue underlined
							   'hr' => array( 'borders' => array( 'bottom' => array( 'style' => Border::BORDER_THIN,
																					 'color' => array( Color::COLOR_BLACK,
																					                 ),
																				   ),
																),
											),	//	Bottom border
...
//						echo 'END OF TABLE ' , $this->_tableLevel , ' CELL<br />';
	...
	public function loadIntoExisting($pFilename, PHPExcel $objPHPExcel)
	{
		...
		$loaded = $dom->loadHTMLFile($pFilename, Settings::getLibXmlLoaderOptions());
		if ($loaded === FALSE) {
