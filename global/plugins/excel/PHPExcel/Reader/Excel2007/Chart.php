 ...
 */
namespace plugins\excel\PHPExcel\Reader\Excel2007;
...
use plugins\excel\PHPExcel\Chart\DataSeriesValues;
		...
		foreach($titleDetailPart as $titleDetailElementKey => $titleDetailElement) {
			...
			if (isset($titleDetailElement->rPr)) {
				...
				if (!is_null($fontColor)) {
					$objText->getFont()->setColor( new Color( self::_readColor($fontColor) ) );
				}
