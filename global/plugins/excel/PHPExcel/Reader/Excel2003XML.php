 ...
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Excel2003XML extends ReaderAbstract implements IReader
{
	/**
	 * Formats
	 *
...
//		echo 'Character Set is ',$this->_charSet,'<br />';
	...
	public function listWorksheetNames($pFilename)
	{
		...
		$xml = simplexml_load_file($pFilename, 'SimpleXMLElement', Settings::getLibXmlLoaderOptions());
	...
	public function loadIntoExisting($pFilename, PHPExcel $objPHPExcel)
	{
		...
		if (isset($xml->CustomDocumentProperties)) {
			foreach($xml->CustomDocumentProperties[0] as $propertyName => $propertyValue) {
				...
				$propertyName = preg_replace_callback('/_x([0-9a-z]{4})_/',PHPEXCEL_SPACE.'PHPExcel\Reader\Excel2003XML::_hex2str',$propertyName);
							...
							if (isset($cellData_ss['Type'])) {
								...
								switch ($cellDataType) {
									...
									*/
									...
									case 'DateTime' :
											$type = DataType::TYPE_NUMERIC;
											$cellValue = SharedDate::PHPToExcel(strtotime($cellValue));
											break;
									case 'Error' :
