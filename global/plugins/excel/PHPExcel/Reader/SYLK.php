 ...
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class SYLK extends ReaderAbstract implements IReader
{
	/**
	 * Input encoding
	 *
	...
	public function listWorksheetInfo($pFilename)
	{
		...
		while (($rowData = fgets($fileHandle)) !== FALSE) {
			...
			$rowData = SharedString::SYLKtoUTF8($rowData);
									...
									for ($i=0;$i<strlen($styleSettings);++$i) {
										switch ($styleSettings{$i}) {
											...
											case 'D' :	$formatArray['font']['bold'] = true;
														break;
											case 'T' :	$formatArray['borders']['top']['style'] = Border::BORDER_THIN;
														break;
											case 'B' :	$formatArray['borders']['bottom']['style'] = Border::BORDER_THIN;
														break;
											case 'L' :	$formatArray['borders']['left']['style'] = Border::BORDER_THIN;
														break;
											case 'R' :	$formatArray['borders']['right']['style'] = Border::BORDER_THIN;
														break;
										}
									}
									break;
									...
									for ($i=0;$i<strlen($styleSettings);++$i) {
										switch ($styleSettings{$i}) {
											...
											case 'D' :	$styleData['font']['bold'] = true;
														break;
											case 'T' :	$styleData['borders']['top']['style'] = Border::BORDER_THIN;
														break;
											case 'B' :	$styleData['borders']['bottom']['style'] = Border::BORDER_THIN;
														break;
											case 'L' :	$styleData['borders']['left']['style'] = Border::BORDER_THIN;
														break;
											case 'R' :	$styleData['borders']['right']['style'] = Border::BORDER_THIN;
														break;
										}
									}
									break;
