...
class MD5
{
    ...
    public function add($data)
    {
        ...
        $F = array(PHPEXCEL_SPACE.'PHPExcel\Reader\Excel5\MD5','F');
        $G = array(PHPEXCEL_SPACE.'PHPExcel\Reader\Excel5\MD5','G');
        $H = array(PHPEXCEL_SPACE.'PHPExcel\Reader\Excel5\MD5','H');
        $I = array(PHPEXCEL_SPACE.'PHPExcel\Reader\Excel5\MD5','I');
