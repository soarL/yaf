...
class DateTime {
	...
	public static function DATE($year = 0, $month = 1, $day = 1) {
		...
		$year	= ($year !== NULL)	? SharedString::testStringAsNumeric($year) : 0;
		$month	= ($month !== NULL)	? SharedString::testStringAsNumeric($month) : 0;
		$day	= ($day !== NULL)	? SharedString::testStringAsNumeric($day) : 0;
		if ((!is_numeric($year)) ||
			(!is_numeric($month)) ||
			(!is_numeric($day))) {
			return Functions::VALUE();
