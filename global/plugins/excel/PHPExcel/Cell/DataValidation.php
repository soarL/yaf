...
class DataValidation
{
     ...
     * @var string
     */
    private $_type = DataValidation::TYPE_NONE;
     ...
     * @var string
     */
    private $_errorStyle = DataValidation::STYLE_STOP;
    ...
    public function __construct()
    {
        ...
        $this->_formula1          = '';
        $this->_formula2          = '';
        $this->_type              = DataValidation::TYPE_NONE;
        $this->_errorStyle        = DataValidation::STYLE_STOP;
        $this->_operator          = '';
