...
class IOFactory {
	...
	private static $_searchLocations = [
		['type'=>'IWriter','path'=>'PHPExcel/Writer/{0}.php','class'=> 'plugins\excel\PHPExcel\Writer\{0}'],
		['type'=>'IReader','path'=>'PHPExcel/Reader/{0}.php','class'=> 'plugins\excel\PHPExcel\Reader\{0}']
	];
