 ...
 */
namespace plugins\excel\PHPExcel\Style;
use plugins\excel\PHPExcel\IComparable;
...
class Borders extends Supervisor implements IComparable
{
    ...
    public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
    {
    	...
    	// Initialise values
    	$this->_left				= new Border($isSupervisor, $isConditional);
    	$this->_right				= new Border($isSupervisor, $isConditional);
    	$this->_top					= new Border($isSupervisor, $isConditional);
    	$this->_bottom				= new Border($isSupervisor, $isConditional);
    	$this->_diagonal			= new Border($isSupervisor, $isConditional);
		$this->_diagonalDirection	= Borders::DIAGONAL_NONE;

		// Specially for supervisor
		if ($isSupervisor) {
			// Initialize pseudo-borders
			$this->_allBorders			= new Border(TRUE);
			$this->_outline				= new Border(TRUE);
			$this->_inside				= new Border(TRUE);
			$this->_vertical			= new Border(TRUE);
			$this->_horizontal			= new Border(TRUE);
