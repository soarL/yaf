...
class Fill extends Supervisor implements IComparable
{
	 ...
	 * @var string
	 */
	protected $_fillType	= Fill::FILL_NONE;
	...
	public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
	{
		...
		$this->_startColor			= new Color(Color::COLOR_WHITE, $isSupervisor, $isConditional);
		$this->_endColor			= new Color(Color::COLOR_BLACK, $isSupervisor, $isConditional);
