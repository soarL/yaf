...
use plugins\excel\PHPExcel\Writer\Excel5\Parser;
use plugins\excel\PHPExcel\Calculation;
use plugins\excel\PHPExcel\Calculation\Functions;
use plugins\excel\PHPExcel\Writer\Excel5\Worksheet;
use plugins\excel\PHPExcel\Writer\Excel5\Workbook;
use plugins\excel\PHPExcel\RichText\Run;
use plugins\excel\PHPExcel\Shared\OLE\PPS\File;
use plugins\excel\PHPExcel\Worksheet\MemoryDrawing;

use plugins\excel\PHPExcel\Shared\Excel5 as SharedExcel5;
use plugins\excel\PHPExcel\Shared\Escher;
use plugins\excel\PHPExcel\Shared\Escher\DgContainer;
use plugins\excel\PHPExcel\Shared\Escher\DggContainer;
use plugins\excel\PHPExcel\Shared\Escher\DggContainer\BstoreContainer;
use plugins\excel\PHPExcel\Shared\Escher\DggContainer\BstoreContainer\BSE;
use plugins\excel\PHPExcel\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip;

use plugins\excel\PHPExcel\Shared\Escher\DgContainer\SpgrContainer\SpContainer;
use plugins\excel\PHPExcel\Shared\Escher\DgContainer\SpgrContainer;
use plugins\excel\PHPExcel\Worksheet\BaseDrawing;
...
use plugins\excel\PHPExcel\Shared\OLE\PPS\Root;
 ...
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Excel5 extends WriterAbstract implements IWriter
{
	/**
	 * PHPExcel object
	 *
	...
	public function save($pFilename = null) {
		...
		$this->_writerWorkbook = new Workbook($this->_phpExcel,
		...
		for ($i = 0; $i < $countSheets; ++$i) {
			$this->_writerWorksheets[$i] = new Worksheet($this->_str_total, $this->_str_unique,
