...
class Font
{
	...
	public function writeFont()
	{
		...
		$bCharSet = SharedFont::getCharsetFromFontName($this->_font->getName()); // Character set
		...
		$data .= SharedString::UTF8toBIFF8UnicodeShort($this->_font->getName());
	 ...
	 *
	 */
	private static $_mapUnderline = array(	StyleFont::UNDERLINE_NONE					=> 0x00,
