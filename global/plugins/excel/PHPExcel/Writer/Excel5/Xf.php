...
// */
use plugins\excel\PHPExcel\Style\Borders as StyleBorders;
...
class Xf
{
	...
	*/
	...
	function writeXf()
	{
		...
		$diag_tl_to_rb = $diagonalDirection == StyleBorders::DIAGONAL_BOTH
							|| $diagonalDirection == StyleBorders::DIAGONAL_DOWN;
		$diag_tr_to_lb = $diagonalDirection == StyleBorders::DIAGONAL_BOTH
							|| $diagonalDirection == StyleBorders::DIAGONAL_UP;
	 ...
	 *
	 */
	private static $_mapBorderStyle = array	( StyleBorder::BORDER_NONE				=> 0x00,
											  StyleBorder::BORDER_THIN				=> 0x01,
											  StyleBorder::BORDER_MEDIUM				=> 0x02,
											  StyleBorder::BORDER_DASHED				=> 0x03,
											  StyleBorder::BORDER_DOTTED				=> 0x04,
											  StyleBorder::BORDER_THICK				=> 0x05,
											  StyleBorder::BORDER_DOUBLE				=> 0x06,
											  StyleBorder::BORDER_HAIR				=> 0x07,
											  StyleBorder::BORDER_MEDIUMDASHED		=> 0x08,
											  StyleBorder::BORDER_DASHDOT				=> 0x09,
											  StyleBorder::BORDER_MEDIUMDASHDOT		=> 0x0A,
											  StyleBorder::BORDER_DASHDOTDOT			=> 0x0B,
											  StyleBorder::BORDER_MEDIUMDASHDOTDOT	=> 0x0C,
											  StyleBorder::BORDER_SLANTDASHDOT		=> 0x0D,
											);
	 ...
	 *
	 */
	private static $_mapFillType = array( StyleFill::FILL_NONE					=> 0x00,
										  StyleFill::FILL_SOLID					=> 0x01,
										  StyleFill::FILL_PATTERN_MEDIUMGRAY		=> 0x02,
										  StyleFill::FILL_PATTERN_DARKGRAY		=> 0x03,
										  StyleFill::FILL_PATTERN_LIGHTGRAY		=> 0x04,
										  StyleFill::FILL_PATTERN_DARKHORIZONTAL	=> 0x05,
										  StyleFill::FILL_PATTERN_DARKVERTICAL	=> 0x06,
										  StyleFill::FILL_PATTERN_DARKDOWN		=> 0x07,
										  StyleFill::FILL_PATTERN_DARKUP			=> 0x08,
										  StyleFill::FILL_PATTERN_DARKGRID		=> 0x09,
										  StyleFill::FILL_PATTERN_DARKTRELLIS		=> 0x0A,
										  StyleFill::FILL_PATTERN_LIGHTHORIZONTAL	=> 0x0B,
										  StyleFill::FILL_PATTERN_LIGHTVERTICAL	=> 0x0C,
										  StyleFill::FILL_PATTERN_LIGHTDOWN		=> 0x0D,
										  StyleFill::FILL_PATTERN_LIGHTUP			=> 0x0E,
										  StyleFill::FILL_PATTERN_LIGHTGRID		=> 0x0F,
										  StyleFill::FILL_PATTERN_LIGHTTRELLIS	=> 0x10,
										  StyleFill::FILL_PATTERN_GRAY125			=> 0x11,
										  StyleFill::FILL_PATTERN_GRAY0625		=> 0x12,
										  StyleFill::FILL_GRADIENT_LINEAR			=> 0x00,	// does not exist in BIFF8
										  StyleFill::FILL_GRADIENT_PATH			=> 0x00,	// does not exist in BIFF8
										);
	/**
	 * Map fill type
	 *
	 ...
	 *
	 */
	private static $_mapHAlign = array( StyleAlignment::HORIZONTAL_GENERAL			=> 0,
										StyleAlignment::HORIZONTAL_LEFT				=> 1,
										StyleAlignment::HORIZONTAL_CENTER				=> 2,
										StyleAlignment::HORIZONTAL_RIGHT				=> 3,
										StyleAlignment::HORIZONTAL_FILL				=> 4,
										StyleAlignment::HORIZONTAL_JUSTIFY			=> 5,
										StyleAlignment::HORIZONTAL_CENTER_CONTINUOUS	=> 6,
									  );
	/**
	 ...
	 *
	 */
	private static $_mapVAlign = array( StyleAlignment::VERTICAL_TOP		=> 0,
										StyleAlignment::VERTICAL_CENTER	=> 1,
										StyleAlignment::VERTICAL_BOTTOM	=> 2,
										StyleAlignment::VERTICAL_JUSTIFY	=> 3,
									  );
	/**
	...
	private static function _mapLocked($locked) {
		switch ($locked) {
			case StyleProtection::PROTECTION_INHERIT:		return 1;
			case StyleProtection::PROTECTION_PROTECTED:	return 1;
			case StyleProtection::PROTECTION_UNPROTECTED:	return 0;
			default:												return 1;
		}
	}
	...
	private static function _mapHidden($hidden) {
		switch ($hidden) {
			case StyleProtection::PROTECTION_INHERIT:		return 0;
			case StyleProtection::PROTECTION_PROTECTED:	return 1;
			case StyleProtection::PROTECTION_UNPROTECTED:	return 0;
			default:												return 0;
		}
