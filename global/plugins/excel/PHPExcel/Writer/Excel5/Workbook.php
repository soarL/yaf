...
class Workbook extends BIFFwriter
{
	 ...
	 */
	public function _addFont(StyleFont $font)
	{
	 ...
	 *
	 * @param PHPExcelWorksheet  $sheet Worksheet name
	...
	private function _writeBoundsheet($sheet, $offset)
	{
		...
		switch ($sheet->getSheetState()) {
			case PHPExcelWorksheet::SHEETSTATE_VISIBLE:	$ss = 0x00; break;
			case PHPExcelWorksheet::SHEETSTATE_HIDDEN:		$ss = 0x01; break;
			case PHPExcelWorksheet::SHEETSTATE_VERYHIDDEN:	$ss = 0x02; break;
	...
	private function _writeDatemode()
	{
		...
		$f1904     = (SharedDate::getExcelCalendar() == SharedDate::CALENDAR_MAC_1904) ?
