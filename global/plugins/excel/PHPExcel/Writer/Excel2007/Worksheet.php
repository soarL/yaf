 ...
 */
namespace plugins\excel\PHPExcel\Writer\Excel2007;

use plugins\excel\PHPExcel\Cell;
use plugins\excel\PHPExcel\Writer\IWriter;
use plugins\excel\PHPExcel\Writer\Exception;
use plugins\excel\PHPExcel\Shared\XMLWriter;
...
class Worksheet extends WriterPart
{
	...
	public function writeWorksheet($pSheet = null, $pStringTable = null, $includeCharts = FALSE)
	{
		if (!is_null($pSheet)) {
			...
			throw new Exception("Invalid PHPExcelWorksheet object passed.");
		}
	}
	 ...
	 * @throws	Exception
	 */
	private function _writeSheetPr(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
		// sheetPr
	 ...
	 * @throws	Exception
	 */
	private function _writeDimension(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
		// dimension
	 ...
	 * @throws	Exception
	 */
	private function _writeSheetViews(XMLWriter $objWriter = NULL, PHPExcelWorksheet $pSheet = NULL)
	{
		// sheetViews
...
//				}
	 ...
	 * @throws	Exception
	 */
	private function _writeSheetFormatPr(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
		// sheetFormatPr
	 ...
	 * @throws	Exception
	 */
	private function _writeCols(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
		// cols
	 ...
	 * @throws	Exception
	 */
	private function _writeSheetProtection(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
		// sheetProtection
	 ...
	 * @throws	Exception
	 */
	private function _writeConditionalFormatting(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
		// Conditional id
		$id = 1;
			...
			foreach ($conditionalStyles as $conditional) {
				...
				if ($conditional->getConditionType() != Conditional::CONDITION_NONE) {
					...
					$objWriter->writeAttribute('sqref',	$cellCoordinate);
						...
						} else if ($conditional->getConditionType() == Conditional::CONDITION_CONTAINSTEXT
	 ...
	 * @throws	Exception
	 */
	private function _writeDataValidations(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
	 ...
	 * @throws	Exception
	 */
	private function _writeHyperlinks(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
	 ...
	 * @throws	Exception
	 */
	private function _writeProtectedRanges(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
	 ...
	 * @throws	Exception
	 */
	private function _writeMergeCells(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
	 ...
	 * @throws	Exception
	 */
	private function _writePrintOptions(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
		// printOptions
	 ...
	 * @throws	Exception
	 */
	private function _writePageMargins(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
		// pageMargins
	 ...
	 * @throws	Exception
	 */
	private function _writeAutoFilter(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
		$autoFilterRange = $pSheet->getAutoFilter()->getRange();
		if (!empty($autoFilterRange)) {
			// autoFilter
	 ...
	 * @throws	Exception
	 */
	private function _writePageSetup(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
		// pageSetup
	 ...
	 * @throws	Exception
	 */
	private function _writeHeaderFooter(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
		// headerFooter
	 ...
	 * @throws	Exception
	 */
	private function _writeBreaks(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
		...
		foreach ($pSheet->getBreaks() as $cell => $breakType) {
			if ($breakType == PHPExcelWorksheet::BREAK_ROW) {
				$aRowBreaks[] = $cell;
			} else if ($breakType == PHPExcelWorksheet::BREAK_COLUMN) {
				$aColumnBreaks[] = $cell;
			}
		}
	 ...
	 * @throws	Exception
	 */
	private function _writeSheetData(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null, $pStringTable = null)
	{
	 ...
	 * @throws	Exception
	 */
	private function _writeCell(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null, $pCellAddress = null, $pStringTable = null, $pFlippedStringTable = null)
	{
...
//								$calculatedValue = $pCell->getCalculatedValue();
	 ...
	 * @throws	Exception
	 */
	private function _writeDrawings(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null, $includeCharts = FALSE)
	{
	 ...
	 * @throws	Exception
	 */
	private function _writeLegacyDrawing(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
	 ...
	 * @throws	Exception
	 */
	private function _writeLegacyDrawingHF(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null)
	{
