...
use plugins\excel\PHPExcel\Style as PHPExcelStyle;
...
class Style extends WriterPart {
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeFill(XMLWriter $objWriter = null, Fill $pFill = null)
	{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeGradientFill(XMLWriter $objWriter = null, Fill $pFill = null)
	{
		// fill
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writePatternFill(XMLWriter $objWriter = null, Fill $pFill = null)
	{
		// fill
		$objWriter->startElement('fill');
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeFont(XMLWriter $objWriter = null, Font $pFont = null)
	{
		// font
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeBorder(XMLWriter $objWriter = null, Borders $pBorders = null)
	{
		// Write border
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeCellStyleXf(XMLWriter $objWriter = null, PHPExcelStyle $pStyle = null, PHPExcel $pPHPExcel = null)
	{
		// xf
		$objWriter->startElement('xf');
			$objWriter->writeAttribute('xfId', 0);
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeCellStyleDxf(XMLWriter $objWriter = null, PHPExcelStyle $pStyle = null)
	{
		// dxf
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeBorderPr(XMLWriter $objWriter = null, $pName = 'left', Border $pBorder = null)
	{
		// Write BorderPr
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeNumFmt(XMLWriter $objWriter = null, NumberFormat $pNumberFormat = null, $pId = 0)
	{
