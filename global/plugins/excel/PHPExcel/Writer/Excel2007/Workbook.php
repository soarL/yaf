...
use plugins\excel\PHPExcel\Shared\Date;
...
class Workbook extends WriterPart
{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeCalcPr(XMLWriter $objWriter = null, $recalcRequired = TRUE)
	{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeSheet(XMLWriter $objWriter = null, $pSheetname = '', $pSheetId = 1, $pRelId = 1, $sheetState = 'visible')
	{
		if ($pSheetname != '') {
			// Write sheet
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeNamedRanges(XMLWriter $objWriter = null, PHPExcel $pPHPExcel)
	{
		// Loop named ranges
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefinedNameForNamedRange(XMLWriter $objWriter = null, NamedRange $pNamedRange)
	{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefinedNameForAutofilter(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null, $pSheetId = 0)
	{
		// definedName for autoFilter
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefinedNameForPrintTitles(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null, $pSheetId = 0)
	{
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefinedNameForPrintArea(XMLWriter $objWriter = null, PHPExcelWorksheet $pSheet = null, $pSheetId = 0)
	{
