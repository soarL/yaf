...
use plugins\excel\PHPExcel\Style\Supervisor;
...
class Style extends Supervisor implements IComparable
{
    ...
    public function __construct($isSupervisor = false, $isConditional = false)
    {
        ...
        $this->_font              = new Font($isSupervisor, $isConditional);
        $this->_fill              = new Fill($isSupervisor, $isConditional);
        $this->_borders           = new Borders($isSupervisor, $isConditional);
        $this->_alignment         = new Alignment($isSupervisor, $isConditional);
        $this->_numberFormat      = new NumberFormat($isSupervisor, $isConditional);
        $this->_protection        = new Protection($isSupervisor, $isConditional);
