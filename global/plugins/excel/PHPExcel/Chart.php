...
use plugins\excel\PHPExcel\Legend;
use plugins\excel\PHPExcel\PlotArea;
/**
 * PHPExcel_Chart
 *
 * @category	PHPExcel
...
class Chart
{
	 ...
	 */
	public function __construct($name, Title $title = null, Legend $legend = null, PlotArea $plotArea = null, $plotVisibleOnly = true, $displayBlanksAs = '0', Title $xAxisLabel = null, Title $yAxisLabel = null)
	{
		$this->_name = $name;
		$this->_title = $title;
		$this->_legend = $legend;
